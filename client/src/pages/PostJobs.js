    ...
    const items = [
        {
            ...
            label: `About Job`,
            children: 
                <Form layout="vertical" className="mt-2" onFinish={onCompletion}>
                    <hr />
        ...
        },
        {
            ...
            children: 
                <Form layout='vertical' onFinish={onFinalCompletion}>
                    <hr />
                        <div className='flex items-center justify-center font-mo text-sm'>Basic Details</div>
                    <hr />
                    <Row>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <Button htmlType="submit" className='font-comf font-bold text-sm hover:scale-125 mr-8 savem'>Submit</Button>
                    </div>
                </Form>
        },
    ];
